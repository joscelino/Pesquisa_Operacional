...
# Constrains
model += lpSum(var[0] * composition[0][0] + var[1] * composition[1][0] + var[2] * composition[2][0]) \
         <= availabilities[0]
model += lpSum(var[0] * composition[0][1] + var[1] * composition[1][1] + var[2] * composition[2][1]) \
         <= availabilities[1]
model += lpSum(var[0] * composition[0][2] + var[1] * composition[1][2] + var[2] * composition[2][2]) \
         <= availabilities[2]
