...
availabilities: object = np.array(
    [
        1500,
        2600,
        3400,
...
weekly_manufacture: object = np.array(
    [
        800,
        1200,
        650,
...
# Goal function
model += lpSum(
    variable_costs[x][i] * var_2[(x, i)] for x, i in var_2
) * annual_weeks + lpSum(var_1[y] * fixed_costs[y] for y in cities)
